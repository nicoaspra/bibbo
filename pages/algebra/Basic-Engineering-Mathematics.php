        ...
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">
                    Basic Engineering Mathematics</h2>
...
<section class="mbr-section article content1 cid-rY3xHcms64" id="content1-g">
        ...
        <div class="media-container-row">
            ...
            <br/><br/>
                ...
                \int_a^b (2x^2+5x) \,dx &= \frac{2x^{2+1}}{2+1}+\frac{5x^{1+1}}{1+1}+C \\
                        &= \frac{2}{3}x^3+\frac{5}{2}x^2+C \tag{ans}
                \end{align}
...
<section class="mbr-section article content1 cid-rY6Bg6544x" id="content2-u">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-7">
                <blockquote>
                    <strong>Lorem ipsum</strong> dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque. Nunc posuere purus rhoncus pulvinar aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet porttitor venenatis. Donec a dui et dui fringilla consectetur id nec massa. Aliquam erat volutpat. Sed ut dui ut lacus dictum fermentum vel tincidunt neque. Sed sed lacinia lectus. Duis sit amet sodales felis. Duis nunc eros, mattis at dui ac, convallis semper risus. In adipiscing ultrices tellus, in suscipit massa vehicula eu Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque. Nunc posuere purus rhoncus pulvinar aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet porttitor venenatis. Donec a dui et dui fringilla consectetur id nec massa. Aliquam erat volutpat. Sed ut dui ut lacus dictum fermentum vel tincidunt neque. Sed sed lacinia lectus. Duis sit amet sodales felis. Duis nunc eros, mattis at dui ac, convallis semper risus. In adipiscing ultrices tellus, in suscipit massa vehicula eu.
                </blockquote>
            </div>
        </div>
    </div>
...
<section class="mbr-section content6 cid-rY3xFUpPgp" id="content6-f">
...
<section class="mbr-section content6 cid-rY6AnaRxfP" id="content6-o">
...
<section class="mbr-section article content12 cid-rY6BdAX6Ue" id="content12-s">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ul>
                    <li><strong>MOBILE FRIENDLY</strong> - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque. Nunc posuere purus rhoncus pulvinar aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet porttitor venenatis.&nbsp;</li>
                    <li><strong>EASY AND SIMPLE</strong> - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque. Nunc posuere purus rhoncus pulvinar aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet porttitor venenatis.&nbsp;</li>
                    <li><strong>UNIQUE STYLES</strong> - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque. Nunc posuere purus rhoncus pulvinar aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet porttitor venenatis.&nbsp;</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="mbr-section article content12 cid-rY6BTH0iWR" id="content12-y">
...
<section class="mbr-section article content12 cid-rY6BZ6fbAa" id="content12-z">
...
<section class="mbr-section article content11 cid-rY6BeljeY9" id="content11-t">
...
<section class="cid-rY3B5QMuXO" id="image4-h">
        ...
        <div class="media-container-row">
            <div class="row col-12 col-md-12">
                <div class="col-12 mbr-text mbr-fonts-style col-md-4 display-7">
                     <p class="p-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam hendrerit nisi sed sollicitudin pellentesque. Nunc posuere purus rhoncus pulvinar aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet porttitor venenatis.&nbsp;</p>
                </div>
...
<section class="features11 cid-rY6Czu4CmM" id="features11-12">
...
<section class="section-table cid-rY6D8tgFuF" id="table1-13">
        ...
        <div class="container scroll">
          <table class="table" cellspacing="0">
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7">Jeanna Schmal</td><td class="body-item mbr-fonts-style display-7">Jeanna Schmal</td><td class="body-item mbr-fonts-style display-7">Jeanna Schmal</td><td class="body-item mbr-fonts-style display-7">Jeanna Schmal</td></tr></tbody>
          </table>
        </div>
