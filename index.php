...
<body>
  <section class="menu cid-rY414x3gx3" once="menu" id="menu1-n">
...
<section class="engine"><a href="https://mobirise.info/s">free bootstrap theme</a></section><section class="header10 cid-rY3tfUVsL5 mbr-fullscreen mbr-parallax-background" id="header10-2">
    ...
    <div class="container">
        <div class="media-container-column mbr-white p-5 align-left">
            ...
            <p class="mbr-text pb-3 mbr-fonts-style display-5">
               Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, aspernatur, voluptatibus, atque, tempore molestiae.</p>
            <div class="mbr-section-btn"><a class="btn btn-md btn-primary display-4" href="index.php#services3-3">COURSES</a>
                <a class="btn btn-md btn-white-outline display-4" href="Contact-Us.php">CONTACT US</a></div>
        </div>
    </div>
...
<section class="services3 cid-rY3tswGyAB" id="services3-3">
    <!---->
        ...
        <div class="row">
                ...
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        <div class="top-line pb-1">
                            <h4 class="card-title mbr-fonts-style display-5">Basic Engineering Mathematics</h4>
                            <p class="mbr-text card-title cost mbr-fonts-style m-0 display-5"></p>
                        </div>
                        <div class="bottom-line">
                            <p class="mbr-text mbr-fonts-style display-7"><a href="sub-Algebra.php">Algebra</a> | Advanced Algebra | Trigonometry | Analytic Geometry | Solid Mensuration</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        <div class="top-line pb-3">
                            <h4 class="card-title mbr-fonts-style display-5">Calculus</h4>
                            <p class="mbr-text card-title cost mbr-fonts-style m-0 display-5"></p>
                        </div>
                        <div class="bottom-line">
                            <p class="mbr-text mbr-fonts-style display-7">Differential Calculus | Integral Calculus | Differential Equations | Advanced Mathematics</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card px-3 col-12 col-md-6">
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        <div class="top-line pb-3">
                            <h4 class="card-title mbr-fonts-style display-5">Engineering Sciences</h4>
                            <p class="mbr-text card-title cost mbr-fonts-style m-0 display-5"></p>
                        </div>
                        <div class="bottom-line">
            ...
            <div class="card px-3 col-12 col-md-6">
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        <div class="top-line pb-3">
                            <h4 class="card-title mbr-fonts-style display-5">Mechanical Engineering Major</h4>
                            <p class="mbr-text card-title cost mbr-fonts-style m-0 display-5"></p>
                        </div>
                        <div class="bottom-line">
                            <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="card px-3 col-12 col-md-6">
                <div class="card-wrapper media-container-row media-container-row">
                    <div class="card-box">
                        <div class="top-line pb-3">
                            <h4 class="card-title mbr-fonts-style display-5">
                                Electrical Engineering Major</h4>
                            <p class="mbr-text card-title cost mbr-fonts-style m-0 display-5"></p>
                        </div>
                        <div class="bottom-line">
                            <p class="mbr-text mbr-fonts-style display-7">
...
<section class="testimonials1 cid-rY3u9lk3Ji" id="testimonials1-6">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 align-center">
                <h2 class="pb-3 mbr-fonts-style display-2">MEET OUR TEAM</h2>
                <h3 class="mbr-section-subtitle mbr-light pb-3 mbr-fonts-style display-5">Entusiastic individuals working for extraordinary learning experience</h3>
            </div>
        </div>
    </div>
...
<section class="mbr-section contacts2 cid-rY3u0tswrM" id="contacts2-4">
    <!---->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-4">
                        <div class="b b-adress">
                            ...
                            <p class="mbr-text align-left mbr-fonts-style display-7">4500 Bicol University - East Campus, Legazpi City, Albay, Philippines</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="b b-phone">
...
<section once="footers" class="cid-rY3ux7smxv" id="footer6-7">
